...
biden = cv2.imread('images/biden_1.jpg')
biden2 = cv2.imread('images/biden_2.jpg')
...
# Trying with first two images
import face_recognition

known_image = face_recognition.load_image_file("biden_1.jpg")
